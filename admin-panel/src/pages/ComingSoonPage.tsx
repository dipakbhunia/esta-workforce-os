...
const pageTitles: Record<string, ComingSoonPageProps> = {
  ...
  '/scheduling/shift-roster': { moduleName: 'Scheduling', title: 'Shift Roster', description: 'Roster planning will be added after shift assignment APIs are ready.', plannedPhase: 'Scheduling' },
  ...
  '/crm/leads': { moduleName: 'CRM', title: 'Lead Management', description: 'Lead tracking will be introduced when the CRM module begins.', plannedPhase: 'CRM' },
  ...
  '/projects/kanban': { moduleName: 'Projects & Tasks', title: 'Kanban Board', description: 'Kanban planning will be part of the task management module.', plannedPhase: 'Task Management' },
  '/projects/calendar': { moduleName: 'Projects & Tasks', title: 'Calendar', description: 'Project calendar planning will be introduced with task management.', plannedPhase: 'Task Management' },
