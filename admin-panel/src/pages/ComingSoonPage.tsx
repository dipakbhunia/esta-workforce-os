...
const pageTitles: Record<string, ComingSoonPageProps> = {
  ...
  '/scheduling/roster-templates': { moduleName: 'Scheduling', title: 'Roster Templates', description: 'Create reusable roster structures for recurring workforce schedules.', plannedPhase: 'Scheduling' },
