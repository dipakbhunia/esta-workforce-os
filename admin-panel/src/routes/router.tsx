...
const comingSoonRoutes: ComingSoonRoute[] = [
  ...
  { path: 'scheduling/shift-assignments', title: 'Shift Assignments', moduleName: 'Scheduling', description: 'Employee-to-shift assignment workflows are reserved for the scheduling expansion phase.', plannedPhase: 'Scheduling', permission: 'shifts:manage', roles: hrRoles },
  { path: 'scheduling/shift-roster', title: 'Shift Roster', moduleName: 'Scheduling', description: 'Roster planning will be added after shift assignment APIs are ready.', plannedPhase: 'Scheduling', permission: 'shifts:manage', roles: hrRoles },
  ...
  { path: 'crm/leads', title: 'Lead Management', moduleName: 'CRM', description: 'Lead tracking will be introduced when the CRM module begins.', plannedPhase: 'CRM', permission: 'settings:view', roles: managerRoles },
  ...
  { path: 'projects/kanban', title: 'Kanban Board', moduleName: 'Projects & Tasks', description: 'Kanban planning will be part of the task management module.', plannedPhase: 'Task Management', permission: 'dashboard:view', roles: workforceRoles },
  { path: 'projects/calendar', title: 'Calendar', moduleName: 'Projects & Tasks', description: 'Project calendar planning will be introduced with task management.', plannedPhase: 'Task Management', permission: 'dashboard:view', roles: workforceRoles },
