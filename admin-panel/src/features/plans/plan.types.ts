...
export interface EntitlementCatalogItem { key: string; name: string; group: string; description: string; availability: EntitlementAvailability; assignable: boolean; sortOrder: number }
