...
const rolePermissions: Record<RoleName, Permission[]> = {
  ...
  COMPANY_ADMIN: ['dashboard:view', 'companies:manage', 'branches:manage', 'branches:view', 'departments:manage', 'departments:view', 'designations:manage', 'designations:view', 'organization:manage', 'people:manage', 'attendance:view', 'attendance:manage', 'leave:view', 'leave:manage', 'monitoring:view', 'reports:view', 'settings:view'],
  HR: ['dashboard:view', 'branches:manage', 'branches:view', 'departments:manage', 'departments:view', 'designations:manage', 'designations:view', 'organization:manage', 'people:manage', 'attendance:view', 'attendance:manage', 'leave:view', 'leave:manage', 'monitoring:view', 'reports:view', 'settings:view'],
